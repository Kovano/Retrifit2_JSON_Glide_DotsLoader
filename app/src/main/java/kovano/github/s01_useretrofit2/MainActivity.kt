package kovano.github.s01_useretrofit2
...
import kovano.github.s01_useretrofit2.api.ApiRequest
import kovano.github.s01_useretrofit2.api.BASE_URL
import kovano.github.s01_useretrofit2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.floatingActionButton.setOnClickListener(){
            binding.floatingActionButton.animation.apply {
                    rotationMatrix(360F)
                    duration = 1000
                    }.start()
            makeApiRequest()
